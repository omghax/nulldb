...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "LICENSE.txt", "Manifest.txt", "README.txt", "Rakefile", "init.rb", "lib/active_record/connection_adapters/nulldb_adapter.rb", "lib/nulldb_rspec.rb", "nulldb.gemspec", "spec/nulldb_spec.rb", "tasks/database.rake"]
  s.has_rdoc = true
  ...
  s.test_files = ["spec/nulldb_spec.rb"]
